...
const RegisterForm = () => {
  ...
  const validate = values => {
    ...
    if (values.imgUrlPattern && !imgUrlPattern.test(values.profileImgUrl)) {
      errors.imgUrlPattern = 'Invalid profile URL format. URL must point to a valid .jpg, .jpeg, .png, or .gif file. Example: http://example.com/example.jpg'
    }
